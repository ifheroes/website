                ...
                <div class="col-sm">
                    <div class="support_background_box">
                        ...
                        <h1 class="title_support"><span class="icon material-symbols-rounded">
                            ...
                            ?>
                            <br>
                            <form action="support-threads.php" method="post">
                                <button><b>Mehr Artikel...</b></button>
                ...
                <div class="col-sm">
                    <div class="support_background_box">
                        ...
                        <h1 class="title_support"><span class="icon material-symbols-rounded">
                            ...
                            ?>
                            <br>
                            <a href="support-threads.php?id=<?php echo $requested_book ?>#focus"><b>Mehr Artikel...</b></a>
                    </div>
                </div>
            </div>
            <br><br>
